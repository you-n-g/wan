...
Fork the repository to your own namespace, and let us take `https://github.com/<username>/wan` as example.

Clone the repository and navigate to the root directory:

```shell
git clone git@github.com:<username>/wan.git
cd wan
```
...
```shell
git remote add upstream https://github.com/you-n-g/wan
git fetch upstream
```
...
```shell
git remote set-url --push upstream git@github.com/<username>/wan.git
```
...
```shell
origin  git@github.com:<username>/wan.git (fetch)
origin  git@github.com:<username>/wan.git (push)
upstream        https://github.com/you-n-g/wan (fetch)
upstream        git@github.com:<username>/wan.git (push)
```
